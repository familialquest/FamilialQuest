    ...
    public class OnlineGroupListFilter : ListFilter
    {
        ...
        public void OnClick_ButtonChangeStatusFilter(Ricimi.PopupOpener editPopupOpener)
        {
            try
            {
                ...
                PopupGroupStatusSelectorOnlineGroupPageController taskStatusSelectorPageController = popup.GetComponent<PopupGroupStatusSelectorOnlineGroupPageController>();
